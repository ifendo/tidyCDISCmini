...
app_ui <- function(request) {
  ...
  tagList(
    ...
    navbarPage(title = div(id="logo-id","tidyCDISCmini", img(src="www/tidyCDISC_ICON.png", style="float:left; padding-right:3px; height:25px; width:30px")), 
               id = "navbarID",
               windowTitle = "tidyCDISCmini",
               tabPanel(
