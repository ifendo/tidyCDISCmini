    ...
    shinyjs::hidden(
      div(
        ...
        tabsetPanel(
          ...
          tabPanel(
            div(id = "indv_cic_EventsTab", style = "font-size: 14px;", "Events"),
            br(), br(), br(),
            fluidRow(
              column(10, wellPanel(
                fluidRow(
                  ...
                  column(
                    ...
                    br(), br(),
                    div(
                      id = "indv_cic_events_apply_filter",
                      shinyWidgets::materialSwitch(ns("events_apply_filter"),
                        label = strong(em(h5("Apply Filters"))),
                        status = "primary",
                        value = F
                      ) # should default to false to avoid
            ...
            ,
            div(
              id = "indv_cic_eventsPlot",
              fluidRow(column(10, timevis::timevisOutput(ns("eventsPlot")))),
          ...
          tabPanel(
            div(id = "indv_cic_VisitsTab", style = "font-size: 14px;", "Visits"),
            br(), br(), br(),
            wellPanel(
              ...
              fluidRow(
                ...
                column(
                  3,
                  div(
                    id = "indv_cic_overlay_event_vals",
                    selectizeInput(
